...
const url = "https://portfolio-helper-server.onrender.com/save";
...
function App() {
  ...
  const getProjects = () => {
    fetch("https://portfolio-helper-server.onrender.com/getproject", {
      method: "get",
    })
      .then((res) => res.json())
      .then((response) => {
  ...
  const getTopProjects = () => {
    fetch("https://portfolio-helper-server.onrender.com/top", {
      method: "get",
    })
      .then((res) => res.json())
      .then((response) => {
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (e.target.files[0].size > 0.5 * 1024 * 1024 * 1024) {
                          ...
                          fetch(
                            "https://api.cloudinary.com/v1_1/dkoj7svtw/image/upload",
                            {
                              method: "post",
                              body: data,
                            }
